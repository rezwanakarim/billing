    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="px-4 mb-4">
            <ol class="flex text-sm justify-end text-gray-500">
                ...
                <li class="mr-3">/ </li>
                <li>
                    <a href="{{ route('foodItems.create') }}" class="text-gray-900 dark:text-white">Add
                        Food Item</a>
                </li>
            </ol>
        </div>
        ...
        <div class="px-2 py-2">
            ...
            <div class="p-8 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" action="{{ route('foodItems.update', $foodItem) }}">
                    @csrf
                    @method('patch')
                    {{-- FoodItem name --}}
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-3/4">
                            <input
                                ...
                                id="name" type="text" name="name" value="{{ old('name', $foodItem->name) }}"
